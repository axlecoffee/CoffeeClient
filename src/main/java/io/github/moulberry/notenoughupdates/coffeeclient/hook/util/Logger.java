package io.github.moulberry.notenoughupdates.coffeeclient.hook.util;
...
/**
 * CoffeeLoader file logger.
 * Writes to {@code coffeeloader/coffee-loader.log} in the game directory.
 * Controlled by {@code DO_LOGGING} in
 * {@link io.github.moulberry.notenoughupdates.coffeeclient.hook.CoffeeLoader}.
 */
public class Logger {
    ...
    private static synchronized void log(String level, String msg) {
        ...
        try {
            ...
            try (FileWriter fw = new FileWriter(logFile, true)) {
                if (!headerWritten) {
                    headerWritten = true;
                    fw.write("\n=== CoffeeLoader Session — " + FMT.format(new Date()) + " ===\n");
