...
@NEUAutoSubscribe
@Mod(modid = NotEnoughUpdates.MODID, version = NotEnoughUpdates.VERSION, clientSideOnly = true, useMetadata = true, guiFactory = "io.github.moulberry.notenoughupdates.core.config.MoulConfigGuiForgeInterop")
public class NotEnoughUpdates {
	...
	/**
	 * Registers the biomes for the crystal hollows here so optifine knows they
	 * exists
	 */
	public static final BiomeGenBase crystalHollowsJungle = (new BiomeGenJungle(101, true))
			.setColor(5470985)
			.setBiomeName("NeuCrystalHollowsJungle")
			.setFillerBlockMetadata(5470985)
			.setTemperatureRainfall(0.95F, 0.9F);
	public static final BiomeGenBase crystalHollowsMagmaFields = (new BiomeGenHell(102))
			.setColor(16711680)
			.setBiomeName("NeuCrystalHollowsMagmaFields")
			.setDisableRain()
			.setTemperatureRainfall(2.0F, 0.0F);
	public static final BiomeGenBase crystalHollowsGoblinHoldout = (new BiomeGenMesa(103, false, false))
			.setColor(13274213)
			.setBiomeName("NeuCrystalHollowsGoblinHoldout");
	public static final BiomeGenBase crystalHollowsPrecursorRemnants = (new BiomeGenMesa(104, false, true))
			.setColor(11573093)
			.setBiomeName("NeuCrystalHollowsPrecursorRemnants");
	public static final BiomeGenBase crystalHollowsMithrilDeposit = (new BiomeGenSnow(105, false))
			.setColor(16777215)
			.setBiomeName("NeuCrystalHollowsMithrilDeposits");
	public static final BiomeGenBase crystalHollowsCrystalNucleus = (new BiomeGenJungle(106, true))
			.setColor(5470985)
			.setBiomeName("NeuCrystalHollowsCrystalNucleus")
			.setFillerBlockMetadata(5470985)
			.setTemperatureRainfall(0.95F, 0.9F);
	public static final BiomeGenBase smolderingTomb = (new BiomeGenHell(107))
			.setColor(16777215)
			.setBiomeName("NeuSmolderingTomb");
	public static final BiomeGenBase glaciteMineshaft = (new BiomeGenSnow(108, false))
			.setColor(16777215)
			.setBiomeName("NeuGlaciteMineshaft");
	public static final BiomeGenBase glaciteTunnels = (new BiomeGenSnow(109, false))
			.setColor(16777215)
	...
	/**
	 * Instantiates NEUIo, NEUManager and NEUOverlay instances. Registers keybinds
	 * and adds a shutdown hook to clear tmp folder.
	 */
	@EventHandler
	 ...
	 * If the last chat message was sent <200 ago, will cache the message for
	 * #onTick to handle.
	 */
	...
	public boolean isOnSkyblock() {
		if (!config.misc.onlyShowOnSkyblock)
			return true;
