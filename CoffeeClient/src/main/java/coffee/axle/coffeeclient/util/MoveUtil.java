...
public class MoveUtil {
    ...
    public static float getDirectionYaw() {
        ...
        return MathHelper.wrapAngleTo180_float(
                (float) Math.toDegrees(Math.atan2(mc.thePlayer.motionZ, mc.thePlayer.motionX)) - 90.0f);
    }
    ...
    public static float getAllowedHorizontalDistance() {
        float slipperiness = mc.thePlayer.worldObj
                .getBlockState(new BlockPos(MathHelper.floor_double(mc.thePlayer.posX),
    ...
    public static double[] predictMovement() {
        ...
        if (inputMagnitude >= 1.0E-4f) {
            ...
            return new double[] { strafeInput * cosYaw - forwardInput * sinYaw,
