    ...
    public static float getToolEfficiency(ItemStack itemStack) {
        ...
        if (itemStack != null) {
            if (itemStack.getItem() instanceof ItemTool) {
                ...
                if (efficiency > 1.0f && (enchantLevel = EnchantmentHelper
                        .getEnchantmentLevel(Enchantment.efficiency.effectId, itemStack)) > 0) {
    ...
    public static double getArmorProtection(ItemStack itemStack) {
        ...
        if (itemStack != null) {
            if (itemStack.getItem() instanceof ItemArmor) {
                ...
                if (itemStack.isItemEnchanted()) {
                    protection += (double) EnchantmentHelper.getEnchantmentLevel(Enchantment.protection.effectId,
                            itemStack) * 0.25;
                }
            }
        }
